// features/admain/presentation/pages/delete_account_screen.dart
...
class DleteAccountScreen extends StatefulWidget {
  DleteAccountScreen({
    Key? key,
  }) : super(key: key);
  @override
  _DleteAccountScreenState createState() => _DleteAccountScreenState();
}

class _DleteAccountScreenState extends State<DleteAccountScreen> {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            IdFiled(controller: IdController, titel: 'Account ID'),

// features/admain/presentation/pages/delete_product.dart
...
class DeleteProductScreen extends StatefulWidget {
  ...
  DeleteProductScreen({Key? key,}) : super(key: key);
  @override
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: txt('Delete Product', Colors.white, 20, false),
      ),
      body:  Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                 ...
                 IdFiled(controller: IdController, titel: 'Product ID'),

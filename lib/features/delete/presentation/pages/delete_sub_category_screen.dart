// features/admain/presentation/pages/delete_sub_category_screen.dart
...
class DeleteSubCategoryScreen extends StatefulWidget {

  DeleteSubCategoryScreen({Key? key,}) : super(key: key);
  @override
  _DeleteSubCategoryScreenState createState() => _DeleteSubCategoryScreenState();
}

class _DeleteSubCategoryScreenState extends State<DeleteSubCategoryScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: txt('Delete SubCategory', Colors.white, 20, false),
      ),
      body:  Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                    ...
                    child: Column(
                      children: [
                        Padding(
                          ...
                          child: Text(
                            'Enter the SubCategory ID to delete it',
                 ...
                 IdFiled(controller: IdController, titel: 'SubCategory ID'),

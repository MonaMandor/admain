// features/admain/presentation/widgets/delete_widget.dart
...
class DleteWidget extends StatelessWidget {
  DleteWidget({super.key});

  List<String> servicesImages = [
    //AssetManger.favorite,
    AssetManger.dleteGreen,
    AssetManger.dleteGreen,
    AssetManger.dleteGreen,
    AssetManger.dleteGreen,
        ...
        child: GridView.count(
          ...
          children: List.generate(servicesNames.length, (index) {
            return GestureDetector(
              onTap: () {
                Modular.to.pushNamed(DleteWidgets[index]);
              },
              child: Container(
